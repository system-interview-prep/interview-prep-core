...
def test_session_contract() -> None:
    ...
    assert _session({"id": "s1", "type": "Chat", "language": "English", "status": "Open", "started_at": now, "ended_at": None})["ended_at"] is None


@pytest.mark.parametrize(("method", "path", "kwargs"), [("get", "/ai/sessions", {}), ("post", "/ai/session", {"json": {"type": "Chat"}})])
